    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <div>
            <h3 className="font-bold text-white text-lg leading-tight">Sign up</h3>
            <p className="text-[11px] text-[var(--text-muted)] mt-1">
              Create a new account to start playing and earning.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form className="space-y-3 mt-2" onSubmit={handleSubmit}>
          <div className="space-y-1.5">
            <label className="text-xs text-[var(--text-muted)]">First name</label>
            <input
              type="text"
          ...
          <div className="space-y-1.5">
            <label className="text-xs text-[var(--text-muted)]">Last name</label>
            <input
              type="text"
              className="w-full rounded-xl bg-[var(--bg-card)] border border-[var(--border)] px-3 py-2.5 text-sm text-white outline-none focus:border-[var(--gold)] focus:bg-[var(--bg-elevated)] transition-colors"
          ...
          <button
            ...
            className="w-full mt-1 rounded-xl bg-emerald-600 text-white text-sm font-semibold py-2.5 hover:bg-emerald-500 transition-colors cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
          >
          ...
          <div className="pt-3">
            ...
            <div className="flex justify-center pt-3">
              <button
                type="button"
                className="w-11 h-11 rounded-full bg-[#0088cc] text-white flex items-center justify-center hover:bg-[#0099dd] transition-colors cursor-pointer shadow-[0_0_16px_rgba(0,136,204,0.5)]"
              >
