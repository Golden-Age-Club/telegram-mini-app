      ...
      >
        ...
        <div className="space-y-3 mt-2">
          ...
          <div className="flex items-center justify-between pt-1">
            <button className="text-xs text-emerald-400 hover:text-emerald-300 cursor-pointer">
              Forgot password?
            </button>
          </div>

          <button className="w-full mt-1 rounded-xl bg-emerald-600 text-white text-sm font-semibold py-2.5 hover:bg-emerald-500 transition-colors cursor-pointer">
            Proceed
          </button>
